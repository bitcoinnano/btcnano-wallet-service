...
```
### Configuration
Configuration for all required modules can be specified in https://github.com/bitcoinnano/btcnano-wallet-service/blob/master/config.js
